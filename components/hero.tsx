...
const Hero = (props: Props) => {
  return (
    <section id="hero" className="w-full h-screen text-center flex justify-center items-center" >
        <div className="group w-3/4 md:w-1/2 p-8 mx-auto my-auto  rounded-2xl border border-neutral-600 shadow-md bg-neutral-50/25 dark:bg-neutral-900/25 dark backdrop-blur-sm" >
            ...
            <p className="py-4 md:text-6xl font-bold text-neutral-700 dark:text-neutral-200" >
            ...
            <p className="py-2 md:text-6xl font-bold text-neutral-700 dark:text-neutral-200" >
                Web Developer
            </p>
